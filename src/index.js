...
function getWelcomeResponse(response) {
    ...
    var cardTitle = "Child o rama";
    var repromptText = "Would you like to play a game or tell a story?";
    var speechText = "<p>Child o rama.</p> <p>What would you like to do? Play a game or tell a story?</p>";
    var cardOutput = "Child o rama. What would you like to do? Play a game or tell a story?";
...
function handleFirstEventRequest(intent, session, response) {
    ...
    var repromptText = "With Child o rama, you can play a game or tell a story.  Which do you want to do?";
    ...
    */
    ...
    if (_choice == "game") {
        ...
        speechText = "You selected game. This isn't working now.";
        sessionAttributes.mychoice = "game";
    } else if (_choice == "story") {

        speechText = "Let's create a story ... what will this story be about?";
        sessionAttributes.mychoice = "story";
    } 
